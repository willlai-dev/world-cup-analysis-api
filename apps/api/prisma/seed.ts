  ...
  BRA: [
    {
      ...
      club: "Real Madrid",
      shirt: 7,
      ratingTier: RatingTier.S,
      overall: 91,
      role: PlayerRole.STARTER,
      injury: RiskLevel.LOW,
    },
    {
      n: 2,
      nameEn: "Rodrygo",
    ...
    },
    {
      ...
      shirt: 5,
      ratingTier: RatingTier.A,
      overall: 84,
      role: PlayerRole.STARTER,
      injury: RiskLevel.MEDIUM,
    },
    {
      n: 4,
      nameEn: "Alisson",
...
const NEWS: NewsSeed[] = [
  {
    n: 1,
    source: "Reuters",
    titleEn: "Brazil edge Spain in thriller",
    summaryEn: "Vinicius scores twice as Brazil beat Spain 2-1.",
    category: NewsCategory.MATCH,
    tags: [
      { name: "Brazil", type: NewsTagType.TEAM },
      { name: "Vinicius Junior", type: NewsTagType.PLAYER },
    ],
  },
  {
    n: 2,
    source: "BBC",
    titleEn: "Mbappé fit for France semi-final",
    summaryEn: "France confirm Mbappé recovered from a minor knock.",
    category: NewsCategory.INJURY,
    tags: [
      { name: "France", type: NewsTagType.TEAM },
      { name: "Kylian Mbappé", type: NewsTagType.PLAYER },
      { name: "injury", type: NewsTagType.INJURY },
    ],
  },
  {
    n: 3,
    source: "Guardian",
    titleEn: "Argentina rely on Messi magic",
    summaryEn: "Messi inspires Argentina past England 3-2.",
    category: NewsCategory.PLAYER,
    tags: [
      { name: "Argentina", type: NewsTagType.TEAM },
      { name: "Lionel Messi", type: NewsTagType.PLAYER },
    ],
  },
  {
    n: 4,
    source: "AP",
    titleEn: "Germany rebuild under Nagelsmann",
    summaryEn: "Tactical shifts give Germany fresh momentum.",
    category: NewsCategory.TACTIC,
    tags: [
      { name: "Germany", type: NewsTagType.TEAM },
      { name: "tactics", type: NewsTagType.TACTIC },
    ],
  },
  {
    n: 5,
    source: "FIFA",
    titleEn: "Semi-final schedule confirmed",
    summaryEn: "Kick-off times announced for the semi-finals.",
    category: NewsCategory.TOURNAMENT,
    tags: [{ name: "tournament", type: NewsTagType.TOPIC }],
  },
];
  ...
  const reports = [
    {
      ...
      title: "巴西國家隊分析",
      content:
        "巴西擁有頂級鋒線與穩定後防，整體評級為 S。資料更新時間以最新快照為準。",
    ...
    },
    {
      ...
      title: "巴西 vs 法國 賽前分析",
      content:
        "兩支 S 級球隊對決，傾向小比分勝負，需注意中場控制。預測僅供參考，不構成保證。",
      structuredJson: {
    ...
    },
    {
      ...
      title: "冠軍預測綜合報告",
      content:
        "綜合各模型，南美與歐洲強權並列熱門，最終結果仍受抽籤與狀態影響。",
