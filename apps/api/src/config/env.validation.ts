...
export const envSchema = z.object({
  ...
  QWEN_OPENAI_BASE_URL: z.string().default('https://dashscope-intl.aliyuncs.com/compatible-mode/v1'),
  QWEN_DASHSCOPE_BASE_URL: z.string().default('https://dashscope-intl.aliyuncs.com/api/v1'),
